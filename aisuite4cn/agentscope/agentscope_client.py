...
from agentscope.models.model import ModelWrapperBase, ModelResponse
from agentscope.formatters import OpenAIFormatter, CommonFormatter
from agentscope.manager import FileManager
from agentscope.message import Msg, ToolUseBlock


class AgentScopeClientWrapperBase(ModelWrapperBase, ABC):
    """The model wrapper for AgentScope.
