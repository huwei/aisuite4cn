    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if is_openai_v1():
            ...
            if not values.get("client"):
                values["client"] = aisuite4cn.Client(**client_params).chat.completions
            if not values.get("async_client"):
                values["async_client"] = aisuite4cn.AsyncClient(**client_params).chat.completions
        else:
            pass
...
class LangchainClient(BaseLLM):
    """LangchainClient large language models.
