...
class XiaomiProvider(BaseProvider):
    """
    A provider for the Xiaomi API.
    """

    def __init__(self, **config):
        """
        Initialize the Xiaomi provider with the given configuration.
        Pass the entire configuration dictionary to the Xiaomi client constructor.
        """
